...
LABEL org.opencontainers.image.source=https://github.com/selim13/node-ts-template
LABEL org.opencontainers.image.description="A template for a Node.js application using Typescript"
